    ...
    <div className="relative min-h-screen">
      ...
      <header className="fixed top-0 left-0 w-full z-50 flex justify-center pt-6 mt-9">
        <button
          ...
          className={`transition-all duration-300 py-[13px] px-5 bg-white rounded-xl shadow-all-xl flex items-center justify-start space-x-3 max-w-[1400px] w-full
